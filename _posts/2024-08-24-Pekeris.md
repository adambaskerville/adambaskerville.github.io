---
layout: post
title: "T>T: A Modern Implementation of Pekeris’ Helium Calculation"
date: 2024-08-24
excerpt: "A direct Python implementation of Chaim Pekeris' 1958 helium calculation."
...
One of the nicest aspects of Pekeris' method is that it is variational. Increase $\omega$, enlarge the determinant, and the energy becomes more negative but will never go below the true, non-relativistic ground state energy (sometimes floating point rounding error can make it seem like it has).
